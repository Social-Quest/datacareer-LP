        ...
        <header className="w-full bg-white font-inter border-b border-[#cccccc] border-solid">
            <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between py-10 ">
                ...
                <nav className="hidden lg:flex items-center gap-2">
                    ...
                    <Link to="https://platform.datacareer.app/sql-questions" className="text-[15px] sm:text-[13px] xl:text-[16px] font-medium text-[#0C153E] leading-6 px-3 sm:px-4 xl:px-2 h-10 xl:h-9 flex items-center rounded-full hover:bg-gray-50">
                        SQL Practice
                    </Link>
                    <span
            ...
            {mobileOpen && (
                <div className="lg:hidden border-t border-[#cccccc] bg-white">
                    <div className="mx-auto max-w-[1200px] px-4 py-3 space-y-3">
                        ...
                        <Link to="https://platform.datacareer.app/sql-questions" className="block text-[15px] sm:text-[16px] font-normal text-[#0C153E] leading-6 px-3 py-2 rounded-lg hover:bg-gray-50">SQL Practice</Link>
                        <span
